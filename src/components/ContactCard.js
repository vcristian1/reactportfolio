...
function ContactCard() {
    return (
        <div className="md:ml-20 lg:ml-20 md:mr-20 lg:mr-20 md:mb-20 lg:mb-20 md:p-20 lg:p-20 lg:-mt-14">
            <h2 id="contact" className="text-center mt-5 ml-2 mb-10 lg:mt-20 tracking-tight text-4xl">Contact</h2>
            <p className="font-thin mt-4 mb-4 text-2xl text-gray-500">Please reach out via Email or LinkedIn if you wish to connect or collaborate.</p>     
